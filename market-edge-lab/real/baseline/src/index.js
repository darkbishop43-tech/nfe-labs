...
export default {
  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/founder-execution-proof") {
      ...
      const proofReady=armed && shadow?.assetCoverageReady===true && shadow?.status==="LIVE_KALSHI_SHADOW" && readyCandidates.length>0;
