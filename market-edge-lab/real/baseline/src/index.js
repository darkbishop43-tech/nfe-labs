...
async function load(){
  ...
  try{
    ...
    const drawFocusChart=(asset)=>{
      ...
      const ema=focusEma?emaSeries(vals,200):[];
      ...
      let body='<line class="base" x1="0" y1="38" x2="100" y2="38"></line>';
